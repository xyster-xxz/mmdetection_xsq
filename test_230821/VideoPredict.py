...
def switch_failure_type(type_id):
    try:
        if type_id == 1:
            ...
            config_file = 'test_230821/work_dirs/concrete_weights/yolov3_d53_mstrain-1920_1080_1class_concrete_weights.py' # 网络模型
            checkpoint_file = 'test_230821/work_dirs/concrete_weights/best_bbox_mAP_epoch_335.pth' # 训练好的模型参数
        elif type_id == 2:
            type_name = 'hanging_string' # 吊弦
            config_file = 'test_230821/work_dirs/hanging_string/yolov3_d53_mstrain-2688_1512_2class_hanging_string.py' # 网络模型
            checkpoint_file = 'test_230821/work_dirs/hanging_string/best_bbox_mAP_epoch_325.pth' # 训练好的模型参数           
...
if __name__ == '__main__':
    ...
    video_path = 'test_230821/video' # 需要加载的测试视频的文件路径
    image_path = 'test_230821/image' # 保存测试图片的路径
